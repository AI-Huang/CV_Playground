...
python ./scripts/train_resnet_cifar10_tf.py --n=3 --version=1 --dataset=cifar10 --data_augmentation=random_translation --validation_split=0.0 --batch_size=32 --epochs=200 --optimizer_name=Adam --learning_rate=0.001 --lr_schedule=keras_lr_scheduler --date_time=${date_time} --run=${i};
done
